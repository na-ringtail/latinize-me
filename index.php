...
<head>
    ...
    <meta name="description"
          content="Аўтаматычны транслітаратар у лацінку. Аўтаматычны лацінізатар. Перавесці тэкст у лацінку. Aŭtamatyčny
    translitaratar у łacinku. Pieraviesci tеkst u łacinku. Транслітараваць. Translitaravać. Лацінізаваць. Łacinizavać.">
    <meta name="keywords"
    ...
    <form id="transForm" class="row">
        <div class="col-lg-6 lm-col-1">
            <div class="form-group">
                ...
                <div class="float-right lm-btn-top">
                    <button type="submit" class="btn btn-danger">Лацінізаваць</button>
                </div>
                <textarea class="form-control" id="input" required placeholder="Напішыце што небудзь"></textarea>
                <div class="float-right lm-btn-bottom">
                    <button type="submit" class="btn btn-danger">Лацінізаваць</button>
                </div>
            </div>
        </div>
        <div class="col-lg-6 lm-col-2">
...
<script src="lacin.js?v=1.0.20" charset="utf-8" language="JavaScript"></script>
</body>
</html>